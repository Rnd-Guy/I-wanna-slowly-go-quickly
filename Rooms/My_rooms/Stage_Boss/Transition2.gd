...
func setup():
	...
	if $"../PostChorus1".get_camera_pos().y > 6000:
		$objCameraDynamic.set_global_position($"../PostChorus1".get_camera_pos())
	else:
		$objCameraDynamic.set_global_position(Vector2(2000,6850))
